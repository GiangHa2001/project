...
?>
   ...
   <div class="container">
    <div class="card">
        ...
        <div class="clearfix">
            <img src="img/hinhchay/cf1.jpg" class="col-md-6 float-md-end mb-3 ms-md-3" alt="ảnh minh họa"> 
             <p class="nd">Tại các thành phố nhộn nhịp không thể thiếu gì những quán cafe đẹp độc lạ, nhưng hôm nay mình sẽ giới thiệu đến bạn một quán cafe mới mở mang phong cách thiên nhiên- <strong class="mau" >The Fast Coffee</strong>.</p>
            <p class="nd"><strong>Địa chỉ:</strong> <strong class="mau">101 Lý Tự Trọng</strong> </p>
            <p class="nd"><strong class="mau" >The Fast Coffee</strong> mang trong mình phong cách thiên nhiên vô cùng độc đáo, yên bình, mới lạ hứa hẹn sẽ làm hài lòng tất cả các khách trải nghiệm cũng như các khách hàng khó tính nhất cùng với các đồ uống khác nhau và các món "cafe muối" đặc sắc.</p>
            <p class="nd">Điều quan trọng đối với các tín đồ "sống ảo" chính là không gian với lối thiết kế đậm chất hướng về thiên nhiên, không gian bên trong nhẹ nhàng ấm cúng, thu hút nhiều bạn trẻ đến để check in.</p>
            <p class="nd">Hãy đến với <strong class="mau" >The Fast Coffee</strong> để trải nghiệm và mang về cho mình những bức hình thật lung linh nhé các bạn.</p>
            </p>
          </div>
    </div> 
  </div>
