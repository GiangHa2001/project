...
?>
    ...
    <section class="manicontent my-3">
      ...
      <strong class="bg-danger text-white fs-4 ">LIÊN HỆ</strong>
  </div>
  <!---->
  <h2><font color="#ff1313">FAST COFFEE</font></h2>
  <p class="td">Địa chỉ: <strong class="chu">101 Lý Tự Trọng</strong></p>
  <p class="td"> Hotline: <strong> <a href="tel:+84963985374" target="_blank" class="lk1">0963 985 374 </a></strong></p>
  <p class="td">Email: <a href="mailto:giangc2200003@student.edu.vn" target="_blank" class="lk1"><strong class="chu"> thefastcoffee@gmail.com</strong></a></p>
  <!--Thêm google map vào trang web-->
  <div><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3928.7654249656994!2d105.77773869999999!3d10.036205999999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a0881ee7ce190f%3A0x4238862e321ae89b!2zMTAxIMSQLiBMw70gVOG7sSBUcuG7jW5nLCBBbiBDxrAsIE5pbmggS2nhu4F1LCBD4bqnbiBUaMahLCBWaeG7h3QgTmFt!5e0!3m2!1svi!2s!4v1697005353331!5m2!1svi!2s" width="100%" height="350px" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>
  <br/>
<!---->
<!-- <form action="" name="frkt" id="frkt" method="post">
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label" name="txthoten" id="txtten">Họ tên</label>
    <input type="text" class="form-control" name="txthoten" id="txthoten" placeholder="Nhập họ và tên"/>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label" name="txtdt" id="txtdt">Điện thoại</label>
    <input type="text" class="form-control" name="txtdt" id="txtdt" placeholder="Nhập số điện thoại"/>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label" name="txtemail" id="txtimaiil" >Email</label>
    <input type="text" class="form-control" name="txtemail" id="txtemail" placeholder="Nhập email"/>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label" name="txtdc" id="txtdc" >Địa chỉ </label>
    <input type="text" class="form-control" name="txtdc" id="txtdc" placeholder="Nhập địa chỉ"/>
  </div>
    <button class="btn btn-primary" type="button" onclick="gui()">Gửi</button>
    <div id="vungthongbao"></div>
