                        ...
                        <div class="container-fluid">
                          ...
                          <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                              <li class="nav-item">
                                <a class="nav-link text-white active" aria-current="page" href="user.php">Trang chủ</a>
                              </li>
                              <li class="nav-item">
    ...
    <section class="manicontent my-3">
       ...
       <div class="container">
        <div class="card">
            ...
            <div class="row nd">
            <div class="col-md-5 nd3"> <img src="img/hinhchay/cf1.jpg" class="text-center" width="100%" height="430px" alt=""></div>
            <div class="col-md-7">     
              <div class="card-body">
                <h4 class="card-title" >Thông tin quán </h4>
     ...
     <div class="container">
          <div class="card">
            <div class="outer">
              <div class="card-header">BESTSELLE</div>
            </div>
            <div class="cast-list mb-2 py-3 run">
              <div class="row">
                  <div class="large-8 columns">
                      <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="category-icon">
                                <img src="img/best/cclateoreođuongen.png" alt="cfmuoi" class="img-fluid">
                                <h5 style="text-transform: uppercase; font: 13px Times New Roman;">Chocolate Oreo Đường Đen</h5>
                            </div>
                        </div>
                        <div class="item">
                              <div class="category-icon">
                                <img src="img/best/tra-oi-hong.jfif" alt="cfmuoi" class="img-fluid">
                                <h5 style="text-transform: uppercase; font: 13px Times New Roman;">Trà Ổi Hồng</h5>
                              </div>
                        </div>
                        <div class="item">
                              <div class="category-icon">
                                <img src="img/best/matchadaudo.jfif" alt="cfmuoi" class="img-fluid">
                                <h5 style="text-transform: uppercase; font: 13px Times New Roman;">Matcha Đậu Đỏ</h5>
                              </div>
                        </div>
                        <div class="item">
                            <div class="category-icon">
                              <img src="img/best/trasualaitrungdaudo.png" alt="cfmuoi" class="img-fluid">
                              <h5 style="text-transform: uppercase; font: 13px Times New Roman;">Trà Sữa Lai Trứng Đậu Đỏ</h5>
                            </div>
                        </div>
                        <div class="item">
                            <div class="category-icon">
                              <img src="img/best/tra_vai.png" alt="cfmuoi" class="img-fluid">
                              <h5 style="text-transform: uppercase; font: 13px Times New Roman;">Trà Vải</h5>
                            </div>
                        </div>
                      </div>
                  </div>
          ...
          <div class="card">
            <div class="outer">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title">ĐĂNG KÝ TƯ VẤN</h5>
                  <p>Đăng ký email để nhận thông tin mới nhất từ chúng tôi để gửi đến hộp thư của bạn.</p>
                  <div class="input-group mb-3">
                    <input type="text" class="form-control" id="txtdh" placeholder="Nhập email của bạn" aria-label="Nhập email của bạn" aria-describedby="basic-addon2">
                    <span class="input-group-text" id="basic-addon2" onclick="dangky()">Đăng ký</span>
                  </div>
                </form>
                </div>
              </div>
